...
class PrivateOfferTimeChallengeMessage extends BasicPrivateOfferMessage {
    parseMetaData(client, metaArray) {
        ...
        this.subject = Localize.text(client, "message_header_timeOffer_title");
    }
}

module.exports = PrivateOfferTimeChallengeMessage;